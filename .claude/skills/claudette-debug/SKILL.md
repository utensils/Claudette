...
return {
  ...
  showThinking: s.showThinkingBlocks[wsId] !== false,
...
if (wsId) {
  ...
  lines.push('  showThinking: ' + (s.showThinkingBlocks[wsId] !== false));
...
Output keys: `toolCount`, `completedTurns`, `agentStatus`, `scrollGap`, `messageCount`, `lastToolSummary`, `inputJsonValid`, `streaming`, `thinking`, `thinkingEnabled`, `showThinking`
