            ...
            return (
              <div className={styles.terminalCommand}>
                {commandState.isRunning ? (
                  <span title={t("command_running")} aria-label={t("command_running")}>
                    <Cog size={12} className={styles.runningIcon} />
                  </span>
                ) : commandState.exitCode === 0 ? (
                  <span className={styles.successIcon} title={t("command_exited_ok_title")}>✓</span>
                ) : commandState.exitCode !== null ? (
                  <span className={styles.errorIcon} title={t("command_exit_code_title", { code: commandState.exitCode })}>✗</span>
                ) : (
